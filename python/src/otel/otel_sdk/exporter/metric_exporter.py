...
class OTLPMetricExporter(MetricExporter, OTLPMetricExporterMixin):
    ...
    def __init__(
        ...
        self._headers.update(_OTLP_HTTP_HEADERS)
    ...
    def export(self, metrics, **kwargs) -> MetricExportResult:
        ...
        serialized_data = encode_metrics(metrics)
        for delay in _create_exp_backoff_generator(
            ...
            if resp.status in REQUESTS_SUCCESS_STATUS_CODES:
